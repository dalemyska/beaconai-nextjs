      ...
      <div className="container-custom relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-blue-100 mb-10">
            Schedule a free 30-minute consultation to discuss your AI challenges and opportunities.
            During this call, we&apos;ll explore your current situation, business objectives, and
            recommend the right approach to help you achieve measurable results.
          </p>
